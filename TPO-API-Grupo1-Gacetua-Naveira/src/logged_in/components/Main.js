...
import PruebaNav from "./navigation/PruebaNav";
...
function Main(props) {
  ...
  const closeDialog = useCallback(() => {
   ...
   const openContratarDialog = useCallback(()=> {
    setDialogOpen("contratar");
  ...
  const fetchRandomMessages = useCallback(() => {
    ...
    for (let i = 0; i < iterations; i += 1) {
      ...
      const message = {
        ...
        src: person.src,
        date: curUnix,
        text: "Hola, quisiera tomar clases particulares.",
      };
  ...
  const selectDashboard = useCallback(() => {
    smoothScrollTop();
    document.title = "TusClases - Dashboard";
  ...
  const selectPosts = useCallback(() => {
    smoothScrollTop();
    document.title = "TusClases - Posts";
  ...
  const selectSubscription = useCallback(() => {
    smoothScrollTop();
    document.title = "TusClases - Subscription";
  ...
  return (
    ...
    <Fragment>
      ...
      <DialogSelector
        openContratarDialog={openContratarDialog}
      ...
      <main className={classNames(classes.main)}>
        <Routing
          ...
          setPosts={setPosts}
          DialogSelector={openContratarDialog}
        />
      </main>
    </Fragment>
    </body>
